...
public class PostgresUserDao implements UserDao {
        ...
        try {
            ...
            if (user.getId() == null) {
                ...
                try (PreparedStatement pstmt =
                    ...
                    setUserStatement(user, pstmt, id);
                ...
                try (PreparedStatement pstmt = connection.prepareStatement(
                    ...
                    // insert
                    setUserStatement(user, pstmt, user.getId());
                    // update
    ...
    private void setUserStatement(User user, PreparedStatement pstmt, Long id) throws SQLException {
        pstmt.setLong(1, id);
